            ...
            <div class="aa">
                ...
                <table class="aa1"  > 
                    ...
                    <tbody>
                        ...
                        $sql = "select u.user_id,u.email,u.sdt,c.status from user as u, cart as c where u.user_id=c.user_id  AND c.status='added to cart' group by c.user_id";
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            <tr id="a1">     
                                ...
                                <td><a href="chitiet.php?user_id=<?php echo $row['user_id']; ?>"><button class="x1"> Chi tiết</button></a></td>
                                <td><a onclick="return giao()" href="giaohang.php?userid=<?php echo $row['user_id']; ?>"><input type="button" name="giao" id="giao" class="x1" value="Giao hàng"></button></a></td>
