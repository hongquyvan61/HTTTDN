...
<html lang="en">
    ...
    <body style="background-color: #F0F0F0;" data-spy="scroll" data-target="#myScrollspy" data-offset="1">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./ttgd.php" ;>Đơn Hàng</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="main">
            ...
            <div class="aa">
                <h2 class="a0">Các sản phẩm đã bán</h2>
                <table class="aa1"  > 
                    <tr class="aa2">
                        <th>#</th>
                        <th>Shoe_id</th>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT shoes.shoe_id,SUM(cart.quantity),shoes.name FROM cart,shoes WHERE cart.shoe_id=shoes.shoe_id AND cart.status='Paid' GROUP BY shoe_id";
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            <tr id="a1">     
                                ...
                                <td><?php echo $row['SUM(cart.quantity)']; ?></td>
