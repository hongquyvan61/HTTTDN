...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 16, 2022 lúc 01:41 PM
...
INSERT INTO `chi_tiet_xuat_kho` (`ma_xuat_kho`, `id_giay`, `size`, `so_luong_cua_size`) VALUES
(1, 2, 39, 10),
(1, 3, 40, 9),
(2, 2, 39, 10),
(2, 3, 39, 10);
...
(81, 9, 3300000, '2022-10-16 13:21:09', 'Paid', 'sadasda', '0920939', 'dasdsadas');
...
(8, 2, 'Puma Suede', 'Thể thao', 900000, 'img/puma/suede.jpg', 'img/puma/suede2.jpg', 'img/puma/suede3.jpg', 'Sản phẩm luôn thuộc vào một trong những thương hiệu thời trang hàng đầu được thiết kế vô cùng trẻ trung và năng động. Với kiểu dáng gọn gàng, màu sắc cá tính và kiểu dáng thanh thoát các dòng sản phẩm luôn giữ cho mình một sức hút riêng. Sự mạnh mẽ vốn có', 297, 1010),
...
(13, 'ijepy@gmail.com', '746459#7776#', '746459#', 'kho');
...
--
ALTER TABLE `don_hang`
  MODIFY `ma_don_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT cho bảng `giay`
--
ALTER TABLE `giay`
  MODIFY `id_giay` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
