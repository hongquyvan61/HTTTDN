<?php
    ...
    if(!preg_match($regex_email,$email)){
        ...
        ?>
        <meta http-equiv="refresh" content="2;url=../giaodien/Dangki.php" />
        <?php
    }
    ...
    if($rows_fetched>0){
        ...
        <meta http-equiv="refresh" content="1;url=../giaodien/Dangki.php" />
        <?php
    }else{?>
...
//        var_dump($encryptmodel->giaimathongke($tam));
        ...
        $user_registration_query="insert into user(email,pass,sdt,role) values ('$encryptemail','$encryptpass','$encryptsdt','kho')";
//        //die($user_registration_query);
        ...
        <meta http-equiv="refresh" content="3;url=../giaodien/Dangnhap.php" />
