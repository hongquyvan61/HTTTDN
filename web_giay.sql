...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 13, 2022 lúc 12:43 PM
...
(1, 9, 4500000, '2022-09-13 13:41:47', 'Paid', 'Hồng Quý Văn', '0923683724', '1506/4 vo van kiet'),
(2, 9, 7200000, '2022-09-13 17:40:13', 'Paid', 'sadasda', '0909696182', '12321321sad');
...
--
ALTER TABLE `giay`
  MODIFY `id_giay` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `gio_hang`
--
ALTER TABLE `gio_hang`
  MODIFY `id_gio_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `nhap_kho`
--
ALTER TABLE `nhap_kho`
  MODIFY `ma_nhap_kho` int(11) NOT NULL AUTO_INCREMENT;
